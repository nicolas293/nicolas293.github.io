...
root.wm_iconbitmap("icons/Notepad.ico")
lexer = PythonLexer()
...
statusbar = tk.Label(root, text="html", bd=1, relief=tk.SUNKEN, anchor=tk.W)
statusbar.pack(side=tk.BOTTOM, fill=tk.X)

text = Text(width=90, height=80, bg="#333",
    fg = "white", wrap=CHAR, font='20')
